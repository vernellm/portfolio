...
VERSION = 1
HANDINDIR = /home/CSCI2467/handin/$(USER)/lab3
DRIVER = ./sdriver.pl
TSH = ./tsh
TSHREF = ./tshref
TSHARGS = "-p"
CC = gcc
CFLAGS = -Wall -O2 -ggdb
FILES = $(TSH) ./myspin ./mysplit ./mystop ./myint ./myread

all: $(FILES)

tsh: tsh.c fork.o
	$(CC) $(CFLAGS) -Wl,--wrap,fork -o tsh tsh.c fork.o
...
rtest18:
	$(DRIVER) -t trace18.txt -s $(TSHREF) -a $(TSHARGS)
rtest19:
	$(DRIVER) -t trace19.txt -s $(TSHREF) -a $(TSHARGS)
rtest20:
